    ...
    <header class="header">
        <div class="header-inner">
            ...
            <ul class="header-list is-pc is-tab wow fadeInUp">
                <li class="header-item"><a href="#" class="common-link">宿泊予約</a></li>
                <li class="header-item"><a href="#" class="common-link">観光情報</a></li>
                <li class="header-item"><a href="#question" class="common-link">よくあるご質問</a></li>
